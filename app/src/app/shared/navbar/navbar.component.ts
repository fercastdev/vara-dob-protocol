...
export class NavbarComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  public openSideNavDates : boolean = false;
  ...
  ngOnInit() {
    ...
    //   this.lastOperation = operations[0]?.id;
    // });
  }
  ...
  toggleSidenav(){
    this.openSideNavDates = !this.openSideNavDates
    this.sideNavEvent.emit(this.openSideNavDates)
  }

  checkSideNav($event: boolean){
    this.openSideNavDates = $event
